...
${OBJECTDIR}/_ext/1577468939/CFileComm.o: ../../../Comm/Physical/CFileComm.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CFileComm.o ../../../Comm/Physical/CFileComm.cpp

${OBJECTDIR}/_ext/1577468939/CLoopbackComm.o: ../../../Comm/Physical/CLoopbackComm.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1577468939
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CLoopbackComm.o ../../../Comm/Physical/CLoopbackComm.cpp

${OBJECTDIR}/_ext/1654212647/ICommLayer.o: ../../../Comm/Protocols/ICommLayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1654212647
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1654212647/ICommLayer.o ../../../Comm/Protocols/ICommLayer.cpp

${OBJECTDIR}/_ext/1577468939/CConsoleComm.o: ../../../Comm/Physical/CConsoleComm.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1577468939
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CConsoleComm.o ../../../Comm/Physical/CConsoleComm.cpp

${OBJECTDIR}/_ext/1577468939/CClientSocket.o: ../../../Comm/Physical/CClientSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1577468939
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CClientSocket.o ../../../Comm/Physical/CClientSocket.cpp

${OBJECTDIR}/_ext/1577468939/CUart.o: ../../../Comm/Physical/CUart.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1577468939
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CUart.o ../../../Comm/Physical/CUart.cpp

${OBJECTDIR}/_ext/1290415847/Utils.o: ../../../General/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1290415847
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1290415847/Utils.o ../../../General/Utils.cpp

${OBJECTDIR}/_ext/1654212647/CAutoConnect.o: ../../../Comm/Protocols/CAutoConnect.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1654212647
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1654212647/CAutoConnect.o ../../../Comm/Protocols/CAutoConnect.cpp

${OBJECTDIR}/_ext/677239803/CDebug.o: ../../../Comm/Base/CDebug.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/677239803
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/677239803/CDebug.o ../../../Comm/Base/CDebug.cpp

${OBJECTDIR}/_ext/677239803/CData.o: ../../../Comm/Base/CData.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/677239803
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/677239803/CData.o ../../../Comm/Base/CData.cpp

${OBJECTDIR}/_ext/1654212647/CAsyncReceiver.o: ../../../Comm/Protocols/CAsyncReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1654212647
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1654212647/CAsyncReceiver.o ../../../Comm/Protocols/CAsyncReceiver.cpp

${OBJECTDIR}/_ext/1654212647/TComm.o: ../../../Comm/Protocols/TComm.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1654212647
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1654212647/TComm.o ../../../Comm/Protocols/TComm.cpp

${OBJECTDIR}/_ext/1577468939/CLoggerComm.o: ../../../Comm/Physical/CLoggerComm.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1577468939
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../../../ -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1577468939/CLoggerComm.o ../../../Comm/Physical/CLoggerComm.cpp
